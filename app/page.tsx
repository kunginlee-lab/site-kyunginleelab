  ...
  return (
    <>
      ...
      <section className="hero-bg">
        <div className="mx-auto max-w-6xl px-6 pb-24 pt-28 sm:pb-32 sm:pt-40">
          <p className="eyebrow mb-5">{site.nameEn} · Software Studio</p>
          <h1 className="max-w-3xl text-[2.75rem] font-extrabold leading-[1.12] tracking-tight sm:text-6xl">
            일상을 가볍게 만드는
            <br />
            소프트웨어를 만듭니다.
          </h1>
          ...
          <div className="mt-11 flex flex-wrap gap-3">
            ...
            <a
              ...
              className="rounded-full border border-line bg-surface px-7 py-3.5 text-sm font-semibold transition-colors hover:border-accent hover:text-accent-ink"
            >
              문의하기
            </a>
          </div>
      ...
      {/* Principles */}
      <section id="about" className="scroll-mt-20 border-y border-line bg-surface">
        <div className="mx-auto max-w-6xl px-6 py-20 sm:py-24">
          ...
          <div className="mt-12 grid gap-x-10 gap-y-12 sm:grid-cols-3">
            {principles.map((p) => (
              <div key={p.no} className="border-t border-line pt-6">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {apps.map((app) => (
              <Link
                key={app.slug}
                href={`/${app.slug}/`}
                className="group flex flex-col gap-6 rounded-3xl border border-line bg-surface p-8 transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-black/5"
              >
                <div className="flex items-center gap-5">
                  <Image
                    ...
                    width={72}
                    height={72}
                    className="h-18 w-18 rounded-2xl border border-line"
                  />
                  <div>
